...
[classnames](https://github.com/JedWatson/classnames) is great improvement but it doesn't help to build in clean way the hierarchy nature of the css structure.

So the difference is that
 - the `classnames` creates a class name(s) according an array of class names _while_ 
 - the `dyna-class-name` creates the class name(s) based on a class name.
 
The `dyna-class-name`  makes the definition of the class names in javascript and in less/sass scripts to be closer.
